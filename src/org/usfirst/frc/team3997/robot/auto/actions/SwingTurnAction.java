...
public class SwingTurnAction extends Action{
	...
	public SwingTurnAction(MasterController controllers, double leftDistance, double rightDistance, double maxSpeed, double timeout, boolean waitForTimeout) {
	...
	public void start() {
		...
		driveTrain.leftPID.setSetpoint(leftDistance);
		
		driveTrain.rightPID.setOutputRange(-maxSpeed, maxSpeed);
		driveTrain.rightPID.setPID(P, I, D);
		driveTrain.rightPID.setSetpoint(rightDistance);
