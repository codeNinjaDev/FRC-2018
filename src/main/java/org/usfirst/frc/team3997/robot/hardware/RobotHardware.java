...
public class RobotHardware extends Subsystem {
	/*** Drive Motors ***/
	static public VictorSP leftDriveMotorA, leftDriveMotorB, rightDriveMotorA, rightDriveMotorB;
	/*** Arm Motors ***/
	static public Spark leftArmMotor, rightArmMotor;
	/*** Intake Motors ***/
	...
	/*** Acceleromter for measuring acceleration for motion profiling */
	...
	/*** Gets the Accelerometer X axis */
	public double getAccelX() {
		return accel.getX();
	}

	/*** Gets the Accelerometer Y axis */
	public double getAccelY() {
		return accel.getY();
	}

	/*** Gets the Accelerometer Z axis */
	public double getAccelZ() {
		return accel.getZ();
	}

	/*** Contains code that runs in teleop loop ***/
	public void update() {
		mpu_gyro.getAngle();
	}
